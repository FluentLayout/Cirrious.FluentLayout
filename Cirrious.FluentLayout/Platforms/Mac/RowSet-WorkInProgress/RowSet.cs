...
namespace Cirrious.FluentLayouts.Touch.RowSet
{
    public class RowSetTemplate
    {
        ...
        public IEnumerable<FluentLayout> Generate(NSView container, params Row[] rows)
        {
            for (var i = 0; i < rows.Length; i++)
            {
                var verticalGenerators = new List<Func<NSView, FluentLayout>>();
    ...
    public class Row
    {
        ...
        public Row(IRowTemplate rowTemplate, params NSView[] views)
        {
        ...
        public IEnumerable<NSView> Views { get; set; }
    }

    public interface IRowTemplate
    {
        IEnumerable<FluentLayout> Generate(NSView container, params NSView[] views);
    }
    ...
    public class RowTemplate : IRowTemplate
    {
        ...
        public IEnumerable<FluentLayout> Generate(NSView container, params NSView[] views)
        {
            WeightedWidthColumn firstWeightedColumn = null;
            NSView firstWeightedView = null;
